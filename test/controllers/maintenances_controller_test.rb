...
class MaintenancesControllerTest < ActionController::TestCase
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post :create, maintenance: { cost: @maintenance.cost, date: @maintenance.date, description: @maintenance.description, title: @maintenance.title }
    end
  ...
  test "should update maintenance" do
    patch :update, id: @maintenance, maintenance: { cost: @maintenance.cost, date: @maintenance.date, description: @maintenance.description, title: @maintenance.title }
    assert_redirected_to maintenance_path(assigns(:maintenance))
  end
